...
// MultiBrowser runs the 6 core browser smokes (door-launch, door-tap,
// pointer-drive, music-toggle, reduced-motion, locked-door) against Firefox and WebKit. The a11y smoke is
