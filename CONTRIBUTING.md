...
ha.ggis Hub is end-to-end functional with a 17-gate release matrix in `tools/haggis-eval` and signed JSON reports. Contributions must keep implementation, documentation, and quality gates aligned — the bar is "perfect at the current stage, or actively being made perfect."
