// Build dist, start vite preview, run smoke-paint-timing.mjs, tear
// down. Mirrors run-visual-gate.mjs so the haggis-eval `perf` gate's
// paint-timing entry stays a thin shell-out wrapper.
//
// Exit 0: gate passed.
// Exit 1: any paint metric exceeded budget, page errored, or build
//         failed.
