...
pnpm verify          # tsc --noEmit → eslint → prettier --check → vitest 226 cases → vite build → verify-dist
...
node scripts/run-a11y-gate.mjs          # hand-rolled WCAG 2.2 AA spot-checks
